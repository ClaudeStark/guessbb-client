...
|              | 21.04 | https://github.com/remoweirich/sopra-fs26-group-15-client/commit/<COMMIT-HASH-2> | Extended `globals.css` with new sections (home-hero-*, lobby-form-*, wait-*, badge-inactive) and responsive breakpoints for tablet/mobile/small-phone. Removed all inline style attributes in touched pages. | Consistent design system across the app; mobile-friendly layout. |
